...
export interface CameraPoint {
  ...
  viewPhotoUrl?: string; // Camera view angle/view photo Base64 or URL (legacy/primary)
  viewPhotoUrls?: string[]; // Up to 4 camera view photos (synced with selectedSet count)
